...
let resultTitle, resultBadge, resultSolutionsList, resultDialFill, resultAccentStrip, printDate;
...
function showResult(resultData) {
  ...
  if (resultData.tipe === "HARDWARE") {
    resultBadge.className = "px-3 py-1 rounded-full text-2xl font-extrabold tracking-wider bg-rose-500/10 border border-rose-500/30 text-rose-400 uppercase inline-block";
    ...
    resultBadge.className = "px-3 py-1 rounded-full text-2xl font-extrabold tracking-wider bg-sky-500/10 border border-sky-500/30 text-sky-400 uppercase inline-block";
